...
RSpec.describe Tg::SpamVacancyInteractor do
  describe '#execute' do
    ...
    let(:maximum_complaints) { Tg::SpamVacancyInteractor::COMPLAINT_COUNTER }
    ...
    describe 'full complaint' do
      ...
      let!(:blacklist_full) do
        create(:blacklist_full, contact_information: vacancy.platform_id, complaint_counter: maximum_complaints)
      end
      let(:outcome) { described_class.run(id: vacancy.id) }
